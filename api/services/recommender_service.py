...
from src.config import GENRE_COLUMNS, U_ITEM_NAMES
...
class RecommenderService:
    ...
    def __init__(self, settings: Settings):
        ...
        self.avg_ratings: pd.Series = pd.Series()
        self.total_ratings: pd.Series = pd.Series()
    ...
    def load(self) -> None:
        ...
        try:
            ...
            self.similarity_matrix = self.similarity_matrix.rename(columns=int)
            ...
            if not ratings_path.exists():
                ...
                self.avg_ratings = self.avg_ratings.rename(index=int)
                self.total_ratings = self.total_ratings.rename(index=int)
    ...
    def get_movie_detail(self, movie_id: int) -> dict:
        ...
        # Get genres
        assert self.genre_data is not None
